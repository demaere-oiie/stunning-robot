...
Some of it can be run directly against Cerebras as an inference provider, and otherwise uses [DSPy](https://dspy.ai); the basic approach was to hold a small set of languages and algorithms fixed, and explore what architectural changes improved objectively measured code generation.
